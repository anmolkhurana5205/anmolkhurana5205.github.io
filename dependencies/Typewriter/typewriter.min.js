    ...
    function (e, t, n) {
      ...
      var C = (function () {
        function e(t, n) {
          ...
          if (
            ...
            O(this, "typeOutAllStrings", function () {
              return "string" == typeof u.options.strings
                ? (u.typeString(u.options.strings).pauseFor(1500), u)
              ...
              if (r.length > 0)
                for (var o = 0; o < r.length; o++) {
                  ...
                  i && 3 !== i.nodeType
                    ...
                    : i.textContent &&
                      (n
                        ? u.pasteString(i.textContent, t)
                        : u.typeString(i.textContent, t));
                }
              return u;
            }),
            ...
            O(this, "addReverseCalledEvent", function (e, t) {
              var n =
                ...
                r = u.options.loop;
              return r
                ? u.addEventToStateProperty(e, t, n, "reverseCalledEvents")
                : u;
            }),
                ...
                if (
                  ...
                  switch (
                    ...
                    case c:
                      ...
                      O
                        ? O.appendChild(C)
                        : u.state.elements.wrapper.appendChild(C),
                    ...
                    case v:
                      var L = r.eventArgs,
                        M = L.cb,
                        D = L.thisArg;
                      M.call(D, { elements: u.state.elements });
                      break;
                    case h:
                      var j = r.eventArgs,
                        P = j.node,
          ...
          n && (this.options = A({}, this.options, {}, n)),
